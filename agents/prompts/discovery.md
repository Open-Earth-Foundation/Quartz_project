You are planning web searches for funded climate-related municipal projects.

Target city: {city}
Target country: {country}
Known aliases: {aliases}
Seed domains: {seed_domains}
Preferred domains: {preferred_domains}
Preferred path prefixes: {preferred_paths}
Preferred query fragments: {preferred_fragments}
...
- Bias for active, funded, climate-related or climate-adjacent projects.
