...
- Target **funding sources**: World Bank, Asian Development Bank, Inter-American Development Bank, Green Climate Fund, bilateral donors, national development banks, foundations
...
- Climate finance project databases
- Development bank lending/grant announcements
- Government climate policies with funding allocations
- Municipal climate action plans (especially with budgets)
- Climate resilience frameworks with implementation timelines
- Official project monitoring/progress reports
...
- Policy papers without specific project mentions
- Theoretical climate scenarios

### Additional Instructions

- Keep each phrase concise (6-12 words) and specific to funded projects
- Vary wording to capture different database/search conventions
- Use funding-related keywords: "funded", "financing", "grant", "approved", "implementation", "budget", "financial support"
- Each phrase should be independently searchable and likely to yield project information
